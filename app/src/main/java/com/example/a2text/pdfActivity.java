...
//    private Button choose_image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "inside pdf create" , Toast.LENGTH_SHORT).show();
        chooseFile_btn = (Button) findViewById(R.id.btn_get_pdf);
...
//        path_tv.setText("hello");
    ...
    public void extractTextPdfFile(final Uri uri) throws IOException{
        ...
        try{
            inputStream = pdfActivity.this.getContentResolver().openInputStream(uri);
